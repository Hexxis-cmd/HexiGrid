...
- Local API: authenticated with a local passcode/session and bound to loopback by default; explicit LAN mode adds pairing plus browser anti-forgery checks.
